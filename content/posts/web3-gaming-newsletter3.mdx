...
description: EPIC LEAGUE, the web3 games development studio, has announced a new strategic partnership with Polygon this week. Some of the key aspects of the partnership include the interesting combination of EPIC LEAGUE’s high-spec blockchain game dev services and Polygon’s well-established reputation as a technology provider for ambitious on-chain projects.
